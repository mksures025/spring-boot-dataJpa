...
public class StudentServiceImpl implements StudentService {
	...
	public String updateStudenrt(StudentRegisterDTO studentRegisterDTO) {
		...
		student.setDepartment(Department.builder().DeptName(studentRegisterDTO.getDepartment().getDeptName()).build());

		List<Address> addresses = studentRegisterDTO
				.getAddress().stream().map(address -> Address.builder().city(address.getCity())
						.state(address.getState()).addressType(address.getAddressType()).student(student).build())
